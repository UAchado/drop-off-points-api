...
points_bucket = [
    models.Point(name = "Reitoria", location = "Departamento 25", coordinates = "40.631417730224, -8.657526476133642", image = "https://api-assets.ua.pt/points/v1/image/resizer?imageUrl=https%3A%2F%2Fuaonline.ua.pt%2Fupload%2Fimg%2Fjoua_i_3090.jpg&width=1200"),
    models.Point(name = "CP", location = "Departamento 23", coordinates = "40.62957166653202, -8.655231694880136", image = "https://api-assets.ua.pt/points/v1/image/resizer?imageUrl=https%3A%2F%2Fapi-assets.ua.pt%2Ffiles%2Fimgs%2F000%2F001%2F838%2Foriginal.jpg&width=1200"),
    ...
    models.Point(name = "Cantina de Santiago", location = "Departamento 6", coordinates = "40.630659968175124, -8.659097986459223", image = "https://api-assets.ua.pt/points/v1/image/resizer?imageUrl=https%3A%2F%2Fuaonline.ua.pt%2Fupload%2Fimg%2Fjoua_i_12306.jpg&width=1200"),
    models.Point(name = "Cantina do Crasto", location = "Departamento M", coordinates = "40.62450887522072, -8.656864475040406", image = "https://api-assets.ua.pt/points/v1/image/resizer?imageUrl=https%3A%2F%2Fuaonline.ua.pt%2Fupload%2Fimg%2Fjoua_i_2828.JPG&width=1200"),
...
def test_get_auth_by_email(db):
    
    point = crud.get_auth_by_email(db = db, email = "fake_email")
    assert point == None

    new_point = models.AuthorizationToPoint(
                                email = "fake_email",
                                point_id = 2,
                                )
    db.add(new_point)
    ...
    point_id = crud.get_auth_by_email(db = db, email = "fake_email")
    assert point_id == 2
